package com.bank.bian.savingsaccount.model;
...
/**
 * The BIAN control record for this service domain: "Savings Account Facility Fulfillment Arrangement".
 *
 ...
 * to its asset type (Savings Account Facility). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Savings Account Facility Fulfillment Arrangement";
